...
This version of the script includes the following roles:

* Werewolves, Angel, Witch (save only)
...
* With the new version, it takes 55 minutes for 1890 simulations, or 1.75sec per game (like 14 times lower). Yikes. If I want to take this further, I need to really figure out how to cut down on processing time.
